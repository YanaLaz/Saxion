...
if (idd != null) {
    ...
    document.getElementById("pizza-form").addEventListener("submit", async function(event){
        ...
        if (pizza["price"] > 10000 || pizza["price"]<0){
            alert("Price cannot be more than 10000 and less than 0");
        } else if (pizza["name"] == ""){
            ...
            //Clear form
            document.querySelector("#pizza-form").reset();
            document.getElementById("message").innerHTML = "The pizza has been successfully added";
        }
    })
}
